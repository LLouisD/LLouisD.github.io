...
\vskip 4cm
\begin{center}
\Huge{EXCILL2: Extremal Combinatorics at Illinois}\\
\Large{March 16--18, 2013}\\
\Large{A conference hosted by the Department of Mathematics}\\
\Large{University of Illinois at Urbana-Champaign}\\
\vskip 1em
\url{http://www.math.uiuc.edu/excill2/}
\end{center}
\thispagestyle{empty}
\begin{center}
\vskip 2cm
...
\end{center}
\vfill
\hfill Organizers: J. Balogh, A. Kostochka, B. Lidick\'y, and D.B. West
\vskip 5pt
...
\centerline {\LARGE {\bf Conference Program}}

\def\programentry#1#2{#1  \emph{#2} \\}

\textbf{Saturday, Mar 16}
\vskip -9pt
\line(1,0){250}
...
\speaker{Béla	Bollobás}{a}{The University of Memphis and Cambridge University}
...
%\title{r-hued Coloring of K4-minor Free Graphs}
%\endtitle
...
%\title{On Choosability with Separation of Planar Graphs with Forbidden}
%\endtitle
...
%
%
%\speaker{ Daniel McDonald}{University of Illinois at Urbana-Champaign}
...
\centerline {\LARGE {\bf List of Participants}}
\input{participants}
